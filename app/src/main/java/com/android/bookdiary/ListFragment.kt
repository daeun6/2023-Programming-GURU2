...
import kotlinx.android.synthetic.main.fragment_book_report_list.*
import kotlinx.android.synthetic.main.fragment_book_report_list.view.*
import kotlinx.android.synthetic.main.note_item.*

class ListFragment : Fragment() { //1
    ...
    override fun onCreateView(
        ...
        recyclerView.adapter = NoteAdapter(requireContext(), noteDataArray)
        ...
        while (cursor.moveToNext()) {
            ...
            var data: NoteData = NoteData(str_title, now_page, total_page, str_color)
            noteDataArray.add(data)
        }
